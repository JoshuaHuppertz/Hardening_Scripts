        ...
        1)
            ...
            case $mode_choice in
                ...
                2)
                    ...
                    bash "$HARDENING_Remediation/remediation_script1.sh"
                    bash "$HARDENING_Remediation/remediation_script2.sh"
                    ;;
            esac
            ;;
        2)
            ...
            case $mode_choice in
                1)
                    ...
                    bash "$HARDENING_Audit/1.1.1.6.sh" # Beispiel Skript für Audit
                    bash "$HARDENING_Audit/1.1.1.7.sh" # Beispiel Skript für Audit
                    ;;
                2)
